...
import { SysAdminSidebarItems, patientSidebarVariants } from "@/config";
import styles from "@/styles/admin.module.css";

export default function SysAdminSidebarBody() {
  ...
  return (
    <div className={styles["admin-sidebar-body"]}>
      <nav className={styles["admin-sidebar-content"]}>
        {SysAdminSidebarItems.map((item, index) => {
          ...
          return (
            <motion.button
              ...
              className={
                styles["admin-sidebar-items"] +
                `${item.route === pathname ? ` ${styles["active"]}` : ""}`
              }
            >
      ...
      <div className={styles["admin-sidebar-footer"]}>
        {!isAuthenticated ? (
          ...
          >
            <div className={styles["admin-sidebar-item"]}>
              <LogIn size={20} className={styles["admin-sidebar-item-icon"]} />
            </div>
            <span className={styles["admin-sidebar-item-title"]}>
              Đăng Nhập
            </span>
          ...
          >
            <div className={styles["logout-btn-wrap"]}>
              <LogOut size={20} className={styles["admin-sidebar-item-icon"]} />
            </div>
            <span className={styles["admin-sidebar-item-title"]}>
              Đăng Xuất
            </span>
